...
app.get('/api/gisx/template', async (req, res) => {
    try {
        ...
        const validations = {
            ...
            plan1: { type: 'list', allowBlank: false, formulae: ['"Yes,No"'] },
            plan2: { type: 'list', allowBlank: false, formulae: ['"Yes,No"'] },
            plan3: { type: 'list', allowBlank: false, formulae: ['"Yes,No"'] },
            plan4: { type: 'list', allowBlank: false, formulae: ['"Yes,No"'] },
        ...
        // Add a second demo/example row on row 3
        const demoRow2 = ws.getRow(3);
        demoRow2.values = {
            quotationNo: 'QT20260721-DEMO2',
            title: 'นางสาว',
            nameTh: 'สมหญิง รุ่งเรืองคุมะ',
            nameEn: 'Somying Rungruang',
            lineOfBusiness: 'Ordinary',
            riskLevel: 'Low',
            occupationClass: 'Class 1',
            effDate: '21/07/2026',
            ...
            language: 'Thai',
            copyCount: 1,
            address1: '456/78 Rungruang Mansion',
            address2: '',
            country: 'Thailand',
            province: 'กทม.',
            district: 'บางรัก',
            subDistrict: 'บางรัก',
            zipCode: '10500',
            contactName: 'สมหญิง รุ่งเรืองคุมะ',
            contactPosition: 'ผู้จัดการ',
            contactMobile: '',
            contactPhone: '',
            contactEmail: '',
            ...
            refundRate: '',
            accTitle: 'นางสาว',
            accNameTh: 'สมหญิง รุ่งเรืองคุมะ',
            accNameEn: 'Somying Rungruang',
            accTaxId: '1101800262650',
            accType: 'Compulsory (Base Account)',
            accHeadCountType: 'Non Head Count',
            accHeadCountDesc: '',
            accLineOfBusiness: 'Ordinary',
