...
3. "edit_testcases": แก้ไข Test Case ที่มีอยู่ (data: [{ "index": 1, "name": "ชื่อใหม่", "step": "ขั้นตอนใหม่", "expected": "ผลลัพธ์ใหม่" }] — index เริ่มที่ 1, ใส่เฉพาะ field ที่ต้องการแก้)
4. "clear_all": ล้างข้อมูลทั้งหมด
5. "switch_page": เปลี่ยนหน้า (page: 1 = Test Case Builder, page: 2 = JSON Payload Generator)
6. "export_excel": ดาวน์โหลดไฟล์ Excel
7. "save_history": บันทึกข้อมูลลงประวัติ
8. "add_payloads": สร้าง JSON Payload (schema: { "sheetName": "ชื่อ", "items": [{ "key": "k", "value": "v" }] })
9. "copy_text": คัดลอกข้อความ (data: "ข้อความ")
10. "load_history": โหลดประวัติ (data: index เริ่มที่ 0)
